...
Let's change our microservice definition yaml to reflect that we want 3 pods instead of the one we see.  Download the [ostoy-microservice-deployment.yaml](https://github.com/fasalzaman/aroworkshop/raw/master/yaml/ostoy-microservice-deployment.yaml) and save it on your local machine.
